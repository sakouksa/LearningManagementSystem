            ...
            <div class="media media-card align-items-center">
                ...
                <div class="media-body">
                    <div class="file-upload-wrap file-upload-wrap-2">
                        <input type="file" name="photo" id="Photo" class="multi file-upload-input with-preview"
                            multiple>
            ...
            <div class="row mt-3">
                ...
                <div class="input-box col-lg-6">
                    ...
                    <div class="form-group">
                        <input class="form-control form--control" name="first_name" placeholder="Enter your first name"
                            type="text" value="{{ old('first_name', auth()->user()->first_name) }}">
                ...
                <div class="input-box col-lg-6">
                    ...
                    <div class="form-group">
                        <input class="form-control form--control" placeholder="Enter your second name" type="text"
                ...
                <div class="input-box col-lg-6">
                    ...
                    <div class="form-group">
                        <input class="form-control form--control" type="text" placeholder="Enter your full name"
                ...
                <div class="input-box col-lg-6">
                    ...
                    <div class="form-group">
                        <input class="form-control form--control" placeholder="Enter your email" type="email"
                ...
                <div class="input-box col-lg-12">
                    ...
                    <div class="form-group">
                        <input class="form-control form--control" placeholder="Enter your phone number" type="text"
                ...
                <div class="input-box col-lg-12">
                    ...
                    <div class="form-group">
                        <input class="form-control form--control" placeholder="Enter your address" type="text"
