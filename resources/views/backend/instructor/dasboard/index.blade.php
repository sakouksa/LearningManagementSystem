...
@section('content')
    <div class="page-content">
        @if (!isApprovedUser())
            <div class="alert alert-danger border-0 bg-danger alert dismissible fale show">
                <div class="text-white">
                    <p style="font-size: 20px">Your accoun is inative. plase wait will check & approved</p>
                </div>
            </div>
        @endif
