                  ...
                  <ul class="navbar-nav align-items-center gap-1">
                      ...
                      <li class="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
                          <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="avascript:;"
                              data-bs-toggle="dropdown"><img src="{{ asset('backend/assets/images/county/01.png') }}"
                                  width="22" alt="">
                          </a>
                          <ul class="dropdown-menu dropdown-menu-end">
                              ...
                              <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img
                                          ...
                                          alt=""><span class="ms-2">Khmer</span></a>
                              </li>
                          </ul>
                      </li>
              ...
              <div class="user-box dropdown px-3">
                  <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                      ...
                      <img src="{{ auth()->user()->photo ? asset(auth()->user()->photo) : asset('backend/assets/images/avatars/avatar-1.png') }}"
                          width="110" height="120" class="user-img" alt="user avatar">
                      <div class="user-info">
                          <p class="user-name mb-0">Sak Ousa</p>
                          <p class="designattion mb-0">
                              {{ auth()->user()->exprience ? auth()->user()->exprience : 'No Experience' }}</p>
                      </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
