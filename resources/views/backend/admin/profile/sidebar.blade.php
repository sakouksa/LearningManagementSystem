            ...
            <div class="d-flex flex-column align-items-center text-center">
                ...
                <div class="mt-4">
                    ...
                    <div class="d-flex justify-content-center gap-2 mt-4">
                        <a href="https://www.facebook.com/share/1CSMWKaSW2/?mibextid=wwXIfr" class="btn btn-primary rounded-pill px-4">Follow</a>
                        <a href="https://www.facebook.com/messages/compose/?ids=1CSMWKaSW2" class="btn btn-outline-primary rounded-pill px-4">Message</a>
                    </div>
                </div>
                <hr class="my-4">
            </div>
