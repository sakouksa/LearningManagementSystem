    ...
    <div class="card-body">
        ...
        <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
            <a href="{{ route('course-details', $course->course_name_slug)}}" class="media-img">
                <img class="mr-3 lazy" src="{{ asset($course->course_image) }}"
                    data-src="{{ asset($course->course_image) }}" alt="Related course image">
            </a>
            <div class="media-body">
                ...
                <p class="text-black font-weight-semi-bold lh-18 fs-15">${{ $course->discount_price }} <span
                        class="before-price fs-14">${{ $course->selling_price }}</span></p>
            </div>
        </div><!-- end media -->
        @endforeach
