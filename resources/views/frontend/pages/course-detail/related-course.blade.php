    ...
    <div class="container">
        <div class="related-course-wrap">
            ...
            <div class="view-more-carousel-2 owl-action-styled">
                @forelse ($more_courses_instructor as $course)
                    <div class="card card-item">
                        <div class="card-image">
                            <a href="{{ route('course-details', $course->course_name_slug)}}" class="d-block">
                                <img class="card-img-top" src="{{ asset($course->course_image) }}" width="240"
                                    height="240" data-src="{{ asset($course->course_image) }}" alt="Card image cap">
                            </a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="card-price text-black font-weight-bold">{{ $course->discount_price }} <span
                                        ...
                                        style="margin-left: 10px">{{ $course->selling_price }}</span></p>
